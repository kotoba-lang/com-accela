(ns run-tests
  ...
  test namespaces:
    ...
    accela.main-test  (.cljc) -- portable, listed below
    accela.kotoba-qualification-test  (.clj) -- JVM-only, NOT listed

  The qualification namespace requires kotoba.compiler.core, kotoba.runtime
  and kotoba.wasm-exec to compile src/accela/page_limit.kotoba and execute it on
